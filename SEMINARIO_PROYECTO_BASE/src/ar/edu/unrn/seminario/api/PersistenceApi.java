...
public class PersistenceApi implements IApi {
	...
	@Override
	public void registrarCampaña(String nombre, String descripcion) throws DataEmptyException, NotNullException,
			AppException, DateException, CreationValidationException, InstanceException {

		Campaña camp = new Campaña(nombre, LocalDateTime.now().toString(), LocalDateTime.now().plusMonths(2).toString(),
				descripcion);
	...
	public List<CampañaDTO> obtenerCampañas()
		...
		for (Campaña camp : campañaDao.listarTodos()) {
			campañasDTO.add(
					new CampañaDTO(camp.obtenerId(), camp.obtenerNombreCampaña(), camp.obtenerFechaInicio().toString(),
...
System.out.println();
	...
	@Override
	public List<BeneficioDTO> obtenerCatalogo(Integer idCampaña) throws AppException, NotNullException,
	...
	@Override
	public CampañaDTO obtenerCampañaVigente()
		...
		for (Campaña camp : campañas) {
			if (camp.obtenerFechaFin().isAfter(LocalDateTime.now())) {
				campañaDTO = new CampañaDTO(camp.obtenerId(), camp.obtenerNombreCampaña(),
